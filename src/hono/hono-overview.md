...
Web開発のフレームワークの世界で、最近注目を集めているHono（炎）について学んでいきましょう。「なんでまた新しいフレームワークが...？」と思われるかもしれませんが、Honoにはエッジランタイム時代にぴったりな特徴があります。
...
- **通信速度の地理的限界**: ユーザーからサーバーまでの距離が遠いと遅延増加。光の速度を超えることは不可能に
...
> 光速を超える通信のためのプロトコル
>
> 2024年のエイプリルフールに [RFC 9564](https://www.rfc-editor.org/rfc/rfc9564.html) として公開されました。
> このプロトコルは光速を超える通信を可能にするものですが、現実的な実装はまだ存在しません 😃
